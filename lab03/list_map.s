...
map:
    ...
    # THINK: why a0?
    # Because we are gonna call a function, so use a0 to pass the value
    lw a0, 0(s0)

    # Call the function in question on that value. DO NOT use a label (be prepared to answer why).
    # What function? Recall the parameters of "map"
    # Call the function located at the value of s1
    jalr ra, s1, 0
    ...
    # a0 stores the address of the node!
    add a1, s1, x0
